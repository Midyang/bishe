...
<body>
		...
		<div id="start">
			...
			<div id="head">
				<!-- 标题**导航部分  -->
				<div id="head_text">
				添加二级分类 &lt; <a href="secondcategory/list"> 二级分类列表 </a>  &lt; <a href="back_page/hello.jsp">&nbsp;首页</a>
				</div>
				<!-- 退出登陆部分  -->
			...
			<div id="main">
					<!-- 要提交的表单-->
					<form action="secondcategory/add" method="post" onsubmit="return verify()">
						<!-- 表格-->
						<table id="main_table" border="0" cellpadding="0" cellspacing="0">
							...
							<tr id="table_tr">
								...
								<td >
									<input type="text" name="name" class="content_table" id="name" value="${second.name }"/>
								</td>
								<!--选择所属一级分类-->
