...
<body>
		...
		<div id="start">
			...
			<div id="head">
				<!-- 标题**导航部分  -->
				<div id="head_text">
				编辑一级分类  &lt; <a href="category/list">&nbsp;一级分类列表</a> &lt; <a href="back_page/hello.jsp">&nbsp;首页</a>
				</div>
			</div>
			<!-- 表格-->
			<div id="main">
					<!-- 要提交的表单-->
					<form action="category/update" method="post" onsubmit="return verify()">
						<!-- 表格-->
						<table id="main_table" border="0" cellpadding="0" cellspacing="0">
							...
							<tr id="table_tr">
								...
								<td >
									...
									<input type="text" name="name"  value="${category.name }" id="text_input"/>
								</td>
							</tr>
							<tr id="err_row">
								<td colspan="2">
