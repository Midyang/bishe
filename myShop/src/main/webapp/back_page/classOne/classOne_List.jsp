...
<script type="text/javascript">
	function fenye(curPage){
		...
		location.href="category/list?curPage="+curPage+"&mohu="+name;
	};
	function mohu() {
		var name=document.getElementById("mohu").value;
		location.href="category/list?curPage=1&mohu="+name;
	};
	function selectById(id) {
		location.href="category/selectById?id="+id;
	};
	function deleteById(id,currPage) {
		if(confirm("你确认删除吗?")){
			var name=document.getElementById("mohu").value;
			location.href="category/deleteById?id="+id+"&curPage="+currPage+"&mohu="+name;
		}
	};
	function add(){
		location.href="back_page/classOne/classOne_Add.jsp";
	};
