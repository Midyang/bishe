...
<body>
		...
		<div id="start">
			...
			<div id="head">
				<!-- 标题**导航部分  -->
				<div id="head_text">
				添加商品 &lt; <a href="product/list"> 商品列表 </a>  &lt; <a href="back_page/hello.jsp">&nbsp;首页</a>
				</div>
				<!-- 退出登陆部分  -->
			</div>
			<!-- 表格-->
			<div id="main">
					<!-- 要提交的表单-->
					<form action="product/add" method="post" enctype="multipart/form-data" onsubmit="return verify()">
						<!-- 表格-->
						<table id="main_table" border="0" cellpadding="0" cellspacing="0">
							...
							<tr id="">	
								...
								<td colspan="3">
									<textarea name="description" id="table_textarea">
									</textarea>
								</td>
							</tr>
							<!--第六行 功能按钮-->
